...
static int sd_set_bus_speed_mode(struct mmc_card *card, u8 *status)
{
	...
	printk(KERN_INFO,"Selection of the bus speed in the linux kernel system \n");
...
{
	int err;
	printk(KERN_INFO,"SD card detect call back call from the system \n");
	printk(KERN_INFO,"Inside sd,c function\n");
...
{ 
	printk(KERN_INFO,"SD card remove call back call from the system \n");
	printk(KERN_INFO,"Inside sd,c function\n");
...
{
	int err;
	printk(KERN_INFO,"SD card suspend call back call from the system \n");
	printk(KERN_INFO,"Inside sd,c function\n");
...
{
	int err = 0;
	printk(KERN_INFO,"SD card resume call back call from the system \n");
	printk(KERN_INFO,"Inside sd,c function\n");
...
{ 
	printk(KERN_INFO,"SD card attach to host in init call back call from the system \n");
	printk(KERN_INFO,"Inside sd,c function\n");
	int err;
	u32 ocr, rocr;
	...
	mmc_claim_host(host);
	printk(KERN_INFO,"SD card init sequence successful \n");
	return 0;
